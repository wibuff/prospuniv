...
class Report(object):
    ...
    VTABLEHEAD = VTABLEHEADFMT.format('Item', 'Count', 'Last', 'Avg', 'Ask', 'Bid')
    VTABLEBODFMT = '  {product:<3} {count:>12.2f} {price.last:>12.2f} {price.avg:>12.2f} {price.ask:>12.2f} {price.bid:>12.2f}'
    VTABLETOTFMT = '{product:<5} {count:>12.2f} {price.last:>12.2f} {price.avg:>12.2f} {price.ask:>12.2f} {price.bid:>12.2f}'
